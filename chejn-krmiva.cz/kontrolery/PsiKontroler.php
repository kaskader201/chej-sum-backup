...
class PsiKontroler extends Kontroler
{
 ...
 $celkem = $spravceProduktu->pocetProduktuDleKategorie(1);
...
else
{
  ...
  $strankovani=$spravceNavigace->vratStrankovani($celkem,$stranka,9);
      ...
      $produkty= $spravceProduktu->vratProduktyDleKategorie(1,($stranka*9)-9,9);       
